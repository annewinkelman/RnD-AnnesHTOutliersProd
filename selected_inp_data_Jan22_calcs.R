...
#status1_file_list <- read.table("list_Jan22_status1_files")
...
sel_file_names_list <- read.table("list_Jan22_status1_files_names")
...
sel_stats_file_list <- read.table("selected_Jan22_outlier_stats_files")
...
sel_cnts_file_list <- read.table("selected_Jan22_outlier_cnts_files")
...
sel_data_file_list <- read.table("selected_Jan22_input_files")
...
#      print("work_trait_all_sel",work_trait_all_sel)
	...
	if(!work_file_size){
	   work_trait_name <- trait_list[itrait]
       	   work_dir <- paste0("Jan22_sel_",work_trait_name,"/")
       	   # cnts
