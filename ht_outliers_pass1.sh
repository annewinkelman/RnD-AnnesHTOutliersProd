...
#while [ $ifile -lt 2 ]; do    
    ...
    awk -v lines=2 '/end.time/ {for(i=lines;i;--i)getline; print $0 }' htoutlier_pass1_id_file_${filenum}.R.out > work_temp_date
    ...
    awk '{print $2, $3, $4}' work_temp_date >> htoutlier_pass1_id_file.all.end.times
