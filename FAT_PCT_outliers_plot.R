...
# vars: "AGE_GRP_CD","SSN_CD","CARRY","SAMPLE_REGIME_CD","anmlkey","abnormal","FAT_PCT","FAT_PCT","FAT_PCT","PROT_PCT","TAG","Contemporary.Group"
...
# files
two_pass_data <- read.csv("Jun21_FAT_PCT_twopassoutsum.csv")

two_pass_data[1:4,]

# pass1 keys
# vars: "file","anmlkey","Contemporary.Group","FAT_PCT","hilo","ndata"
keys_pass1 <- read.csv("Jun21_FAT_PCT_allkeysqt4rpass1.csv")
keys_pass1[1:4,]
...
# vars: "file","anmlkey","Contemporary.Group","FAT_PCT","hilo","ndata"
if(file.exists("Jun21_FAT_PCT_allkeysqt4rpass2.csv")){
keys_pass2 <- read.csv("Jun21_FAT_PCT_allkeysqt4rpass2.csv")
keys_pass2[1:4,]
keys_pass2$pass <- 2
}
...
pdf("Jun21_FAT_PCT_outliers.pdf")
