...
# files
two_pass_data <- read.csv("Dec21_PM_VOL_twopassoutsum.csv")

two_pass_data[1:4,]

# pass1 keys
# vars: "file","anmlkey","Contemporary.Group","PM_VOL","hilo","ndata"
keys_pass1 <- read.csv("Dec21_PM_VOL_allkeysqt4rpass1.csv")
keys_pass1[1:4,]
...
# vars: "file","anmlkey","Contemporary.Group","PM_VOL","hilo","ndata"
if(file.exists("Dec21_PM_VOL_allkeysqt4rpass2.csv")){
keys_pass2 <- read.csv("Dec21_PM_VOL_allkeysqt4rpass2.csv")
keys_pass2[1:4,]
keys_pass2$pass <- 2
}
