...
# files
two_pass_data <- read.csv("Sep21_PROT_PCT_twopassoutsum.csv")

two_pass_data[1:4,]

# pass1 keys
# vars: "file","anmlkey","Contemporary.Group","PROT_PCT","hilo","ndata"
keys_pass1 <- read.csv("Sep21_PROT_PCT_allkeysqt4rpass1.csv")
keys_pass1[1:4,]
...
# vars: "file","anmlkey","Contemporary.Group","PROT_PCT","hilo","ndata"
if(file.exists("Sep21_PROT_PCT_allkeysqt4rpass2.csv")){
keys_pass2 <- read.csv("Sep21_PROT_PCT_allkeysqt4rpass2.csv")
keys_pass2[1:4,]
keys_pass2$pass <- 2
}
...
pdf("Sep21_PROT_PCT_outliers.pdf")
