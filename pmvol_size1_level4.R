...
# "carryover","dim","actual_pm_vol","milk_abnm_cd","species_descr","Nstart","cg","qt4","mad","med","absvalue","maddev","outlier4","small","big"
cgdata4 <- read.csv("pm_vol_recalc_size1_data.csv")
nrow(cgdata4)
...
write.csv(twopassoutsum,"pmvol_size1_all2passum.csv", row.names=F)
...
# keys
# pass 1
write.csv(allkeysqt4rpass1,"pmvol_size1_allkeysqt4rpass1.csv", row.names=F, quote=F)

# pass2
write.csv(allkeysqt4rpass2,"pmvol_size1_allkeysqt4rpass2.csv", row.names=F, quote=F)
...
#
write.csv(final_data,"pmvol_size1_level4_outlier_id.csv", row.names=F)
