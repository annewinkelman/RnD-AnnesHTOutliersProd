...
#while [ $ifile -lt 2 ]; do    
    ...
    R CMD BATCH --no-restore "--args "${work_file}"" htoutlier_pass1_id.R htoutlier_pass1_id_Feb22_file_${filenum}.R.out
    awk -v lines=2 '/end.time/ {for(i=lines;i;--i)getline; print $0 }' htoutlier_pass1_id_Feb22_file_${filenum}.R.out > work_temp_date
    ...
    awk '{print $2, $3, $4}' work_temp_date >> htoutlier_pass1_id_Feb22_file.all.end.times
